    ...
    <div className="flex-center" style={{ minHeight: '100vh', padding: '1rem', flexDirection: 'column', gap: '1rem' }}>
      ...
      <div className="glass" style={{ width: '100%', maxWidth: '400px', padding: '2rem' }}>
        <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
          <h1 className="gradient-text" style={{ fontSize: '2rem', fontWeight: 'bold' }}>ExpenseTracker</h1>
          <p style={{ color: 'var(--muted-foreground)', marginTop: '0.5rem' }}>Login to your account</p>
        </div>
